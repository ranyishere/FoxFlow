...
namespace Particles {
    ...
    class Model : public DGGML::Model<graph_grammar_t> {
        ...
        public:
            ...
            // DGGML::CartesianGrid2D test_grid;
            auto tmp = 0.075;
            ...
            */
            ...
            // std::size_t max_particles = test_grid.totalNumCells();
            //step 1 create an ordered number of selectable cells
            std::vector<std::size_t> selected_cells;
            for (int i = max_particles/2; i < max_particles; i++) selected_cells.push_back(i);
            ...
            for (auto i = 0; i < num_mt; i++) {
                ...
                // test_grid.cardinalCellToPoint(x_c, y_c, selected_cells[i]);
                ...
                tmp.a4c6400 = 10;
                tmp.ad89e53[0] = max_x/2 + 1;
                tmp.ad89e53[1] = max_y/2 + i+1;
