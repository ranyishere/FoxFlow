...
torch::Tensor fvel = (torch::tensor({0.0, 0.0, 0.1}, torch::kFloat64));
std::get<Dissolution::FluidSource>(rhs[m2[ 1 ]].data).Velocity = fvel;
...
torch::Tensor fv0 = std::get<Dissolution::FluidSource>(lhs[m1[1]].data).Velocity;

torch::Tensor fv0n = (fv0);
std::get<Dissolution::FluidSource>(rhs[m2[ 1 ]].data).Velocity = fv0n;
...
torch::Tensor fv1n = (fv0);
std::get<Dissolution::Fluid>(rhs[m2[ 2 ]].data).Velocity = fv1n;
torch::Tensor fc0 = std::get<Dissolution::FluidSource>(lhs[m1[1]].data).FCount;
...
torch::Tensor fv1n = (fv0);
std::get<Dissolution::FluidSink>(rhs[m2[ 2 ]].data).Velocity = fv1n;
...
torch::Tensor fv0 = std::get<Dissolution::Fluid>(lhs[m1[1]].data).Velocity;

torch::Tensor fv0n = (fv0);
std::get<Dissolution::Fluid>(rhs[m2[ 1 ]].data).Velocity = fv0n;
torch::Tensor fc0n = (torch::tensor({0}, torch::kFloat64));
...
auto &tensor_ref_2_3 = std::get<Dissolution::Fluid>(lhs[m1[2]].data).Velocity;
double* tensor_ptr_2_3 = tensor_ref_2_3.template data_ptr<double>();
varset.insert(&tensor_ptr_2_3[0]);
varset.insert(&tensor_ptr_2_3[1]);
varset.insert(&tensor_ptr_2_3[2]);
auto &node_2_5 = std::get<Dissolution::Fluid>(lhs[m1[2]].data).Pressure;
varset.insert(&node_2_5);
},
[&](auto &lhs, auto &m1, auto y, auto ydot, auto &varmap) {
double* tensor_ptr_2_3 = std::get<Dissolution::Fluid>(lhs[m1[2]].data).Velocity.template data_ptr<double>();
auto &ix_P1 = std::get<Dissolution::Fluid>(lhs[m1[2]].data).Pressure;
NV_Ith_S(ydot, varmap[&tensor_ptr_2_3[2]]) += 1.0 * (std::get<Dissolution::FluidSource>(lhs[m1[ 1 ]].data).Pressure - std::get<Dissolution::Fluid>(lhs[m1[ 2 ]].data).Pressure);
NV_Ith_S(ydot, varmap[&ix_P1]) += 0.5 * (std::get<Dissolution::FluidSource>(lhs[m1[ 1 ]].data).Pressure - std::get<Dissolution::Fluid>(lhs[m1[ 2 ]].data).Pressure);
}
);
...
[&](auto &lhs, auto &m1, auto y, auto ydot, auto &varmap) {
auto &ix_P1 = std::get<Dissolution::Fluid>(lhs[m1[2]].data).Pressure;
NV_Ith_S(ydot, varmap[&ix_P1]) += 0.5 * (std::get<Dissolution::Fluid>(lhs[m1[ 1 ]].data).Pressure - std::get<Dissolution::Fluid>(lhs[m1[ 2 ]].data).Pressure);
}
);
