...
Particles::ParticleNodeCreator rhs_node_1 = std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data);
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_936c91 = 9;
		rhs[m2[1]].position[0] = start_x+1;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_261168[0] = start_x+1;
		rhs[m2[1]].position[1] = start_y+1;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_261168[1] = start_y+1;
}
);
...
int counter = std::get<Particles::ParticleNodeCreator>(lhs[m[1]].data).fflow_936c91;

return DGGML::heaviside(counter,1);},
[&](auto &lhs, auto &rhs, auto &m1, auto &m2) {
double x = std::get<Particles::ParticleNodeCreator>(lhs[m1[1]].data).fflow_261168[0];

double y = std::get<Particles::ParticleNodeCreator>(lhs[m1[1]].data).fflow_261168[1];

int counter = std::get<Particles::ParticleNodeCreator>(lhs[m1[1]].data).fflow_936c91;
...
Particles::ParticleNode rhs_node_5 = std::get<Particles::ParticleNode>(rhs[m2[5]].data);
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_936c91 = counter-1;
		rhs[m2[1]].position[0] = x-0.2;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_261168[0] = x-0.2;
		rhs[m2[1]].position[1] = y-0.2;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_261168[1] = y-0.2;
		rhs[m2[2]].position[0] = x+0.3;
		std::get<Particles::ParticleNode>(rhs[m2[2]].data).fflow_87fbe5[0] = x+0.3;
		rhs[m2[2]].position[1] = y+0.3;
		std::get<Particles::ParticleNode>(rhs[m2[2]].data).fflow_87fbe5[1] = y+0.3;
		rhs[m2[3]].position[0] = x+0.6;
		std::get<Particles::ParticleNode>(rhs[m2[3]].data).fflow_87fbe5[0] = x+0.6;
		rhs[m2[3]].position[1] = y+0.6;
		std::get<Particles::ParticleNode>(rhs[m2[3]].data).fflow_87fbe5[1] = y+0.6;
		rhs[m2[4]].position[0] = x+0.6;
		std::get<Particles::ParticleNode>(rhs[m2[4]].data).fflow_87fbe5[0] = x+0.6;
		rhs[m2[4]].position[1] = y+0.1;
		std::get<Particles::ParticleNode>(rhs[m2[4]].data).fflow_87fbe5[1] = y+0.1;
		rhs[m2[5]].position[0] = x-0.4;
		std::get<Particles::ParticleNode>(rhs[m2[5]].data).fflow_87fbe5[0] = x-0.4;
		rhs[m2[5]].position[1] = y-0.3;
		std::get<Particles::ParticleNode>(rhs[m2[5]].data).fflow_87fbe5[1] = y-0.3;
}
);
