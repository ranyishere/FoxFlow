...
Particles::ParticleNodeCreator rhs_node_1 = std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data);
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_50d347 = 9;
		rhs[m2[1]].position[0] = start_x+1;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_7a8c2f[0] = start_x+1;
		rhs[m2[1]].position[1] = start_y+1;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_7a8c2f[1] = start_y+1;
}
);
...
int counter = std::get<Particles::ParticleNodeCreator>(lhs[m[1]].data).fflow_50d347;

return DGGML::heaviside(counter,1);},
[&](auto &lhs, auto &rhs, auto &m1, auto &m2) {
int counter = std::get<Particles::ParticleNodeCreator>(lhs[m1[1]].data).fflow_50d347;

double x = std::get<Particles::ParticleNodeCreator>(lhs[m1[1]].data).fflow_7a8c2f[0];

double y = std::get<Particles::ParticleNodeCreator>(lhs[m1[1]].data).fflow_7a8c2f[1];

Particles::ParticleNodeCreator rhs_node_1 = std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data);
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_50d347 = counter-1;
Particles::ParticleNode rhs_node_2 = std::get<Particles::ParticleNode>(rhs[m2[2]].data);
		rhs[m2[2]].position[0] = x+0.3;
		std::get<Particles::ParticleNode>(rhs[m2[2]].data).fflow_a751f4[0] = x+0.3;
		rhs[m2[2]].position[1] = y+0.3;
		std::get<Particles::ParticleNode>(rhs[m2[2]].data).fflow_a751f4[1] = y+0.3;
Particles::ParticleNode rhs_node_3 = std::get<Particles::ParticleNode>(rhs[m2[3]].data);
		rhs[m2[3]].position[0] = x+0.6;
		std::get<Particles::ParticleNode>(rhs[m2[3]].data).fflow_a751f4[0] = x+0.6;
		rhs[m2[3]].position[1] = y+0.6;
		std::get<Particles::ParticleNode>(rhs[m2[3]].data).fflow_a751f4[1] = y+0.6;
Particles::ParticleNode rhs_node_4 = std::get<Particles::ParticleNode>(rhs[m2[4]].data);
		rhs[m2[4]].position[0] = x+0.6;
		std::get<Particles::ParticleNode>(rhs[m2[4]].data).fflow_a751f4[0] = x+0.6;
		rhs[m2[4]].position[1] = y+0.1;
		std::get<Particles::ParticleNode>(rhs[m2[4]].data).fflow_a751f4[1] = y+0.1;
		rhs[m2[1]].position[0] = x-0.9;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_7a8c2f[0] = x-0.9;
		rhs[m2[1]].position[1] = y-0.9;
		std::get<Particles::ParticleNodeCreator>(rhs[m2[1]].data).fflow_7a8c2f[1] = y-0.9;
}
);
